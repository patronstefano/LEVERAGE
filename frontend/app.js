...
const translations = {
  ...
  it: {
    ...
    rankingsHeading: "Rankings",
    rankingsIntro: "I Rankings restano separati per disciplina e ciclo di punteggio, cosi i confronti restano significativi.",
    analyticsHeading: "Analytics",
  ...
  fr: {
    ...
    rankingsTitle: "Voir les Rankings",
    ...
    rankingsHeading: "Rankings",
    rankingsIntro: "Les Rankings restent separes par discipline et cycle de notation pour garder des comparaisons coherentes.",
