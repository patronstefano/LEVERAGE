...
const translations = {
  en: {
    ...
    generateFromProfile: "Import data from profile",
  ...
  it: {
    ...
    generateFromProfile: "Importa dati dal profilo",
  ...
  es: {
    ...
    generateFromProfile: "Importar datos del perfil",
  ...
  fr: {
    ...
    generateFromProfile: "Importer les données du profil",
