...
CORRECTIONS = [
    ...
    },
    {
        ...
        "old_value": 1.2,
        "new_value": 13.2,
        "source_file": "Results 2026.xlsx",
        "source_sheet": "MAG",
        "source_row": 2969,
        "reason": "Gymternet source typo in Champion's Cup AA VT: VT 1.2 is inconsistent with VT AVG 12.85 and VT SUM D 7.6; inferred VT1 score is 13.2",
    },
    {
        "result_id": 765956,
        "field": "score",
        ...
        "source_sheet": "MAG",
        "source_row": 2969,
        "reason": "Derived VT attempt 2 from corrected VT1: (2 * VT AVG 12.85) - 13.2 = 12.5",
    },
    {
        "result_id": 186011,
        "field": "D_score",
        "old_value": 12.8,
        "new_value": None,
        "source_file": "Results 2019.xlsx",
        "source_sheet": "WAG D",
        "source_row": None,
        "reason": "Invalid D_score above 10; source D sheet value matches the final score and cannot be treated as a valid difficulty score",
    },
    {
        "result_id": 241232,
        "field": "D_score",
    ...
    },
    {
        ...
        "source_sheet": "WAG D",
        "source_row": None,
        "reason": "Invalid D_score above 10; no reliable correction can be inferred from the source, so the component is marked not available",
    },
]
