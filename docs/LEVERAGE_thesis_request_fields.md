# LEVERAGE - Thesis Request Fields

Documento di lavoro per la richiesta tesi. La tesi verra scritta in inglese; i campi sono organizzati secondo la struttura richiesta: Titolo, Titolo in lingua, Abstract, Abstract in lingua.
...
LEVERAGE: Design and Development of a Global Web Platform for Artistic Gymnastics Analytics
...
Oltre allo sviluppo software, la tesi include la progettazione dell'identita visiva della piattaforma: logo, wordmark, colore riconoscitivo, stile grafico e interfaccia minimale ispirata a criteri di chiarezza, accessibilita e usabilita. Il progetto comprende inoltre la pubblicazione web, la gestione del dominio e la definizione di una prima strategia di presenza digitale, includendo il potenziale utilizzo di canali social per comunicare, diffondere e consolidare LEVERAGE come riferimento internazionale per l'Artistic Gymnastics Analytics.
...
Beyond software development, the thesis also includes the design of LEVERAGE's visual identity: logo, wordmark, recognizable brand color, graphic style and a minimal interface designed around clarity, accessibility and usability. The project further includes web publication, domain management and the definition of an initial digital presence strategy, including the potential use of social media channels to communicate, disseminate and consolidate LEVERAGE as an international reference for Artistic Gymnastics Analytics.
