...
Dopo una revoca, il badge puo essere riattivato esclusivamente selezionando nuovamente un profilo ufficiale riscontrato e confermando `Importa dati`. Questa regola impedisce che una certificazione pubblica venga assegnata senza un nuovo controllo della fonte. Ricerca, importazione, modifica, revoca e riattivazione sono tutte operazioni protette dai ruoli e registrate nell'audit Admin/Super Admin.
